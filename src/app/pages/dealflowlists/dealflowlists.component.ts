...
export class DealflowListsComponent implements OnInit {
  ...
  constructor(private _dealflowService: DealflowListsService, public toastr: ToastsManager, vcr: ViewContainerRef, private router: Router, private _menuService: BaMenuService) {
